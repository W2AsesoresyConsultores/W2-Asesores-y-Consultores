  ...
  return (
    <div className='w-full h-auto font-dmsans flex justify-center mt-24 flex-wrap'>
        ...
        <h2 className='text-2xl md:text-3xl font-semibold text-center mb-8'>Descubre lo que nos hace diferentes</h2>
            ...
            <img className='w-80 h-60 rounded-lg' 
            src="https://elcuvegbwtlngranjtym.supabase.co/storage/v1/object/public/AssetsW2/DescubriendoTalentos/Aprendizaje%20Continuo.gif"
            alt="foto" />
        </div>
        <div className='flex flex-col items-center justify-around w-[500px] md:mx-16'>
            <div className='flex gap-6 flex-wrap justify-center'>
                <div className='my-2'>
                    <div className='w-16 h-16 bg-teal-300 flex items-center justify-center rounded-lg'>
                        <img 
                        src="https://elcuvegbwtlngranjtym.supabase.co/storage/v1/object/public/AssetsW2/DescubriendoTalentos/healthicons_exercise-yoga.png"
                        alt="icon1" />
                    </div>
                </div>
            ...
            <div className='flex gap-6 flex-wrap justify-center'>
                <div>
                    <div className='w-16 h-16 bg-teal-300 flex items-center justify-center rounded-lg'>
                        <img src="https://elcuvegbwtlngranjtym.supabase.co/storage/v1/object/public/AssetsW2/DescubriendoTalentos/healthicons_exercise-yoga.png" alt="" />
                    </div>
                </div>
                <div className='text-center md:text-left my-2'>
                    <h4 className='text-xl font-semibold w-80'>Flexibilidad en el trabajo</h4>
